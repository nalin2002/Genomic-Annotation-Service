...
class Config(object):
    ...
    AWS_DYNAMO_DB = (
        os.environ["AWS_DYNAMO_DB"]
        if ("AWS_DYNAMO_DB" in os.environ)
        else "nalinprabhath_annotations"
    )

    FREE_MAX_UPLOAD_BYTES = 150 * 1024
    # SNS Configuration
    AWS_SNS_TOPIC_ARN = (
        os.environ["AWS_SNS_TOPIC_ARN"]
        if ("AWS_SNS_TOPIC_ARN" in os.environ)
        else "arn:aws:sns:us-east-1:127134666975:nalinprabhath_a17_job_requests"
    )
    AWS_SNS_TOPIC_GLACIER= "arn:aws:sns:us-east-1:127134666975:nalinprabhath_a16_glacier_notifications"

    # SQS Configuration
    AWS_SQS_THAW_QUEUE_URL = "https://sqs.us-east-1.amazonaws.com/127134666975/nalinprabhath_a16_thaw_requests"
